                            ...
                            <ul class="nav nav-tabs" id="litebans--nav" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a href="/sanctions/mutes"
                                       class="nav-link"><?= $Lang->get('LITEBANS__MUTESS') ?></a>
                                </li>
                                <li class="nav-item">
                                    <a href="/sanctions/kicks"
                                       class="nav-link active"><?= $Lang->get('LITEBANS__KICKSS') ?></a>
                                </li>
                                <li class="nav-item">
                                    ...
                                    foreach ($kicks as $key => $value): $i++ ?>
                                        <tr data-aos="fade-left" data-aos-delay="<?= $i * 100 ?>" data-aos-offset="0"
                                            ...
                                            <td>
                                                ...
                                                <?php elseif (!empty($value['Kicks']['banned_by_name']) || ($value['Kicks']['banned_by_name'] != null && $value['Kicks']['banned_by_uuid'] != null)): ?>
                                                    <div class="liteban--user">
                                                        <img src="https://crafatar.com/avatars/<?= $value['Kicks']['banned_by_uuid'] ?>?size=32"
                                                             alt="<?= $value['Kicks']['banned_by_name'] ?>"
                                                             title="<?= $value['Kicks']['banned_by_name'] ?>">
                                                ...
                                                <?php else: ?>
                                                    <img src="https://crafatar.com/avatars/606e2ff0-ed77-4842-9d6c-e1d3321c7838?size=32"
                                                         alt="<?= $value['Kicks']['removed_by_name'] ?>"
                                                         title="<?= $value['Kicks']['removed_by_name'] ?>">
                                                <?php endif; ?>
                                            </td>
